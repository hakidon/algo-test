...
export default function App() {
    ...
    return (
        <Routes>
            ...
            <Route path="ViewInstrument" element={<ViewInstrument dataIns={dataIns} setDataIns={setDataIns} index={url_param.get('id')} roles={url_param.get('roles')} navigation={navigate} />} />
